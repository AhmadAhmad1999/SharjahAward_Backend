...
namespace SharijhaAward.Persistence.Migrations
{
    ...
    public partial class initDataBase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "cycles",
                columns: new[] { "Id", "ArabicName", "EnglishName", "GroupCategoryNumber", "IndividualCategoryNumber", "RegistrationPortalClosingDate", "RegistrationPortalOpeningDate", "Status", "Year" },
                values: new object[] { new Guid("784454bd-2d6c-49ae-9e8a-1932bd15aac1"), "جائزة الشارقة", "SharijhaAward", 0, 0, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, "2023-2024" });
