...
namespace SharijhaAward.Persistence
{
    public class SharijhaAwardDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            #endregion
            #region CategoryEducationalClass
            modelBuilder.Entity<CategoryEducationalClass>()
                .HasData(new CategoryEducationalClass()
                {
                    Id = 1,
                    isDeleted = false,
                    DeletedAt = null,
                    ...
                    CreatedAt = DateTime.UtcNow,
                    CreatedBy = null,
                    EducationalClassId = 1,
                    CategoryId = 2,
                    NumberOfExpectedWinners = 2
                }, new CategoryEducationalClass()
                {
                    Id = 2,
                    isDeleted = false,
                    DeletedAt = null,
