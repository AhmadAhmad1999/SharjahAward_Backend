...
using SharijhaAward.Application.Features.Cycles.Queries.GetActiveCycleData;
...
namespace SharijhaAward.Api.Controllers
{
    ...
    public class CycleController : ControllerBase
    {
        ...
        [ProducesResponseType(StatusCodes.Status403Forbidden)]
        [ProducesDefaultResponseType]
        public async Task<IActionResult> GetActiveCycleData()
        {
            StringValues? HeaderValue = HttpContext.Request.Headers["lang"];
            ...
            BaseResponse<GetActiveCycleDataDto> Response = await _Mediator.Send(new GetActiveCycleDataQuery()
            {
                lang = HeaderValue!
            });
