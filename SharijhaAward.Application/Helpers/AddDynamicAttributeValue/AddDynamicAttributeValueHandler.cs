...
namespace SharijhaAward.Application.Helpers.AddDynamicAttributeValue
{
        ...
        BaseResponse<AddDynamicAttributeValueResponse>>
    {
        ...
        public async Task<BaseResponse<AddDynamicAttributeValueResponse>> Handle(AddDynamicAttributeValueCommand Request, CancellationToken cancellationToken)
        {
            ...
            using (TransactionScope Transaction = new TransactionScope(TransactionScopeAsyncFlowOption.Enabled))
            {
                try
                {
                    List<DynamicAttributeValue> DynamicAttributeValuesEntities = Request.DynamicAttributesWithValues.Select(x => new DynamicAttributeValue()
                    {
