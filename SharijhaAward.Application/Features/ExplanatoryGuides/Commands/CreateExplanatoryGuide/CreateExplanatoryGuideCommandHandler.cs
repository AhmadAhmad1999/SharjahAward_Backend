...
namespace SharijhaAward.Application.Features.ExplanatoryGuides.Commands.CreateExplanatoryGuide
{
        ...
        : IRequestHandler<CreateExplanatoryGuideCommand, BaseResponse<object>>
    {
        ...
        public CreateExplanatoryGuideCommandHandler(IAsyncRepository<ExplanatoryGuide> explanatoryGuideRepository, IAsyncRepository<Category> categoryRepository, IFileService<ConditionsAttachment> attachmentFileService, IMapper mapper)
        {
