...
namespace SharijhaAward.Application.Features.CriterionFeatures.Commands.CreateCriterion
{
    public class CreateCriterionHandler : IRequestHandler<CreateCriterionCommand,
        BaseResponse<CreateCriterionResponse>>
    {
        ...
        public async Task<BaseResponse<CreateCriterionResponse>> Handle(CreateCriterionCommand Request, CancellationToken cancellationToken)
        {
            ...
            if (CheckIfCategoryIdDoesExist == null)
            {
                ...
                return new BaseResponse<CreateCriterionResponse>(ResponseMessage, false, 404);
            }
                ...
                TransactionOptions, TransactionScopeAsyncFlowOption.Enabled))
            {
                try
                {
                    ...
                    return new BaseResponse<CreateCriterionResponse>(ResponseMessage, true, 200);
                }
                catch (Exception)
                {
                    Transaction.Dispose();
