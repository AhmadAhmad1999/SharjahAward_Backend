...
{
    public class ExportFormsWithAllItsDataToExcelHandler : IRequestHandler<ExportFormsWithAllItsDataToExcelQuery, BaseResponse<byte[]>>
    {
        ...
        private readonly IExcelHelper<ExportFormsWithAllItsDataToExcelListVM> _ExcelHelper;
        public ExportFormsWithAllItsDataToExcelHandler(IAsyncRepository<Arbitration> ArbitrationRepository,
            ...
            IExcelHelper<ExportFormsWithAllItsDataToExcelListVM> ExcelHelper)
        {
        ...
        public async Task<BaseResponse<byte[]>> Handle(ExportFormsWithAllItsDataToExcelQuery Request, CancellationToken cancellationToken)
        {
            ...
            List<ExportFormsWithAllItsDataToExcelListVM> FilesFromCriterionAttachmentes = Response
                .Select(x => new ExportFormsWithAllItsDataToExcelListVM()
                {
                    Id = x.Id,
                    ArbitrationLevelForThisForm = x.ArbitrationLevelForThisForm,
                    ArbitratorsForThisForm = x.ArbitratorsForThisForm.Select(y => y.ArbitratorName).ToList(),
                    CategoryName = x.CategoryName,
                    EducationalClassName = x.EducationalClassName,
                    IsAccepted = x.IsAccepted,
                    PercentCompletion = x.PercentCompletion,
